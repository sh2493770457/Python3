...
from burp import IBurpExtender, IContextMenuFactory, IMessageEditorTabFactory, IMessageEditorTab  # TODO: 导入Burp API接口相关类
from javax.swing import JMenuItem, JTextArea, JScrollPane, JPopupMenu, JMenuItem as JMenuItemCopy  # TODO: 导入Swing组件用于创建菜单项和文本区域
    ...
    def generate_code(self, method, url, headers, params):
        ...
        if method == "GET":
            ...
            if params["query"] and not url_has_params:
                ...
                code_lines.extend([
                    u"",
                    u"params = {}".format(json.dumps(params['query'], ensure_ascii=False, indent=4, convert_bool_to_string=True)),
        ...
        # TODO: 处理post请求
            ...
            if params["json"] is not None:
                code_lines.extend([
                    u"",
                    u"data = {}".format(json.dumps(params["json"], ensure_ascii=False, indent=4, convert_bool_to_string=True)),
                    u"",
                ...
                code_lines.extend([
                    u"",
                    u"data = {}".format(json.dumps(params["form"], ensure_ascii=False, indent=4, convert_bool_to_string=True)),
                    ...
                    if body_bytes and len(body_bytes) > 0:
                        ...
                        if "application/json" in content_type.lower():
                            try:
                                ...
                                self._callbacks.printError(u"JSON解析错误: {}".format(self.safe_unicode(str(e))).encode('utf-8'))
                                request_data = None
                        else:
    ...
    def actionPerformed(self, event):
        ...
        if code and self.python_tab.current_message:
            try:
                ...
                self.extender._callbacks.printError(u"快速保存错误: {}".format(self.extender.safe_unicode(str(e))).encode('utf-8'))
...
class ExportPythonAction(ActionListener):
    ...
    def actionPerformed(self, event):
        ...
        try:
            ...
            self.extender._callbacks.printError(u"导出错误: {}".format(self.extender.safe_unicode(str(e))).encode('utf-8'))
...
class QuickExportAction(ActionListener):
    ...
    def actionPerformed(self, event):
        ...
        try:
            ...
            self.extender._callbacks.printError(u"快速导出错误: {}".format(self.extender.safe_unicode(str(e))).encode('utf-8'))
...
class ExportAPIAction(ActionListener):
    ...
    def actionPerformed(self, event):
        ...
        try:
            ...
            self.extender._callbacks.printError(u"API接口导出错误: {}".format(self.extender.safe_unicode(str(e))).encode('utf-8'))
