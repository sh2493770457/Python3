...
> 仅用于学习,任何非法操作与作者无关
>
> https://uland.taobao.com/sem/tbsearch?localImgKey=&page=3&q=deepseek&tab=all

![image-20250406193509019](./assets/image-20250406193509019.png)

- 进入网站搜索关键字,点击下一页,分析载荷发现有`appKey`,`t`,`sign`等关键字
- 再次请求下一页,发现`t`和`sign`发生变化,如图

![image-20250406193830577](./assets/image-20250406193830577.png)

*****

### 断点调试

- 搜索关键字`sign`,点击下一页的时候在此处断了

![image-20250406194012783](./assets/image-20250406194012783.png)

- 依次打印这几个参数看看

![image-20250406194143621](./assets/image-20250406194143621.png)

- 分析可以得知`token`是一个固定值,`u`为时间戳,`s`为appKey,`n.data`是请求的pamars
- 而`sign`即为`c(r.token + "&" + u + "&" + s + "&" + n.data`
...
```py
# -*- encoding: utf-8 -*-
# TODO:@ModuleName: 某宝热卖(II)-->面向对象
# TODO:@Author: tomato
# TODO:@Version: Python3.12.0
# TODO:@Time: 2025/4/6 18:29
import time
import requests
import hashlib
...
class TbSpider:
    ...
    def __init__(self):
        ...
        # TODO: 动态生成时间戳
        self.tamp = str(int(time.time() * 1000))
        self.params = {
            'jsv': '2.7.2',
            'appKey': '12574478',
            't': self.tamp,
            ...
            'dataType': 'jsonp',
            'callback': 'mtopjsonp13',
            'data': '{"appId":"43356","params":"{\\"device\\":\\"HMA-AL00\\",\\"isBeta\\":\\"false\\",\\"grayHair\\":\\"false\\",\\"from\\":\\"nt_history\\",\\"brand\\":\\"HUAWEI\\",\\"info\\":\\"wifi\\",\\"index\\":\\"4\\",\\"rainbow\\":\\"\\",\\"schemaType\\":\\"auction\\",\\"elderHome\\":\\"false\\",\\"isEnterSrpSearch\\":\\"true\\",\\"newSearch\\":\\"false\\",\\"network\\":\\"wifi\\",\\"subtype\\":\\"\\",\\"hasPreposeFilter\\":\\"false\\",\\"prepositionVersion\\":\\"v2\\",\\"client_os\\":\\"Android\\",\\"gpsEnabled\\":\\"false\\",\\"searchDoorFrom\\":\\"srp\\",\\"debug_rerankNewOpenCard\\":\\"false\\",\\"homePageVersion\\":\\"v7\\",\\"searchElderHomeOpen\\":\\"false\\",\\"search_action\\":\\"initiative\\",\\"sugg\\":\\"_4_1\\",\\"sversion\\":\\"13.6\\",\\"style\\":\\"list\\",\\"ttid\\":\\"600000@taobao_pc_10.7.0\\",\\"needTabs\\":\\"true\\",\\"areaCode\\":\\"SG\\",\\"vm\\":\\"nw\\",\\"countryNum\\":\\"702\\",\\"m\\":\\"pc_sem\\",\\"page\\":3,\\"n\\":48,\\"q\\":\\"deepseek\\",\\"qSource\\":\\"manual\\",\\"pageSource\\":\\"\\",\\"tab\\":\\"all\\",\\"pageSize\\":\\"48\\",\\"totalPage\\":\\"100\\",\\"totalResults\\":\\"5000\\",\\"sourceS\\":\\"48\\",\\"sort\\":\\"_coefp\\",\\"filterTag\\":\\"\\",\\"service\\":\\"\\",\\"prop\\":\\"\\",\\"loc\\":\\"\\",\\"start_price\\":null,\\"end_price\\":null,\\"startPrice\\":null,\\"endPrice\\":null,\\"p4pIds\\":\\"897064354283,864286849298,703472354910,903321520906,848805772951,845781587885,890870831165,657932504386,906239321548,795053877812,771181296558,887717607415,859061092057,799144123508,896224053421,893595724275,891531845667,891878551558,894131599474,889563836435,892188587695,899150419473,900308664917,896224997182,896597160165,892507558023,890149863179,837899848716,899516963242,891738390008,894035080835,889972167882,898463149398,892221839421,895233939118,840771689807,895161649384,896924804279,898945265555,894768526242,618758646400,900563554669,701908943900,782856713317,893218406933,765779182962,708039190429,904008118314,902655801891,892165906121,872415733475,836477630526,906660432211,903594444548,690812402524,850963530571,897562460647,896230135969,891612588216,897669113915,896528917152,892632076540,898530740358,888478884100,901610953665,886148460505,897921510647,770715166966,899068717554\\",\\"categoryp\\":\\"\\",\\"myCNA\\":\\"kjd5IPH/TxsCAY0LK+vUQpGa\\"}"}',
        }
        self.url = 'https://h5api.m.taobao.com/h5/mtop.relationrecommend.wirelessrecommend.recommend/2.0/'
        self.token = '6f20356c0db9ecd898b7b8bddede4ded'
    ...
    def get_sign(self):
        ...
        :return: content
        """
        content = self.token + "&" + self.tamp + "&" + self.params['appKey'] + "&" + self.params['data']
        return content
    ...
    def run(self):
        ...
        :return:
        """
        sign_content = self.get_sign()
        self.md5_encrypt(sign_content)
...
![image-20250406194918046](./assets/image-20250406194918046.png)

整个逆向到这里就完成了,接下来就是提取数据了,感兴趣可以自行深入!
